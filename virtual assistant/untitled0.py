...
def Process_audio():
   ...
   if __name__=='__main__':
       ...
       while True:
           ...
           elif 'play' in statement or 'sound' in statement:
           ...
           elif 'what can i ask you' in statement or 'where'in statement:
